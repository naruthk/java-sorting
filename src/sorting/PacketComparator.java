...
public class PacketComparator implements Comparator<Packet> {
    ...
    public int compare(Packet p1, Packet p2) {
    	int result = p1.getMajorPacketIndex() - p2.getMajorPacketIndex();
    	
    	// if the major packets are the same, then check minor packets
    	if (result == 0) {
    		result = p1.getMinorPacketIndex() - p2.getMinorPacketIndex();
    	}
